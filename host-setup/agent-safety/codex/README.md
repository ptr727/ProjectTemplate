...
all eight requirements against Claude Code's `PreToolUse` hook, including its tokenizer, its
...
implement requirements 1-8. If Codex offers no such extension point at all, that finding belongs on
