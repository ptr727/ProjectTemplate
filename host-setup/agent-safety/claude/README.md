...
- **The sweep reports and never kills.** It cannot tell a leaked wait from a long build backgrounded on purpose, and nothing about ending a process on the maintainer's machine is reversible. It hands over the `kill` line and stops there.
