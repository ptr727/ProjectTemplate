...
```json
{
  ...
  "hooks": {
    ...
    "SessionEnd": [
      { "hooks": [ { "type": "command", "command": "\"python3\" \"<home>/.claude/hooks/stray-process-sweep.py\"", "timeout": 10 } ] }
    ]
  },
  "permissions": {
