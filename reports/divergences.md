...
Generated by `python3 spec/fidelity_honesty.py --report` - do not hand-edit. Curate dispositions in
[`spec/divergences.json`](../spec/divergences.json) and regenerate. Each row reflects a repo's
ground-truth branch at generation time; git dates this file.
...
A past hub revision, not the current canonical - the audit already flags these as DRIFT. Copy the
current file down; no judgment needed.
