...
commit the report under the hub's own `reports/` once authorized, the hub authoring it per
`AUDIT.md` section 8, per `git-commit-conventions`, done means measured, not applied.
