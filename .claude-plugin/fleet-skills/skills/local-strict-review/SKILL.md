...
Quote `AGENTS.md`'s own unresolved-rule closing line ("Context and Delegation Discipline")
  into the prompt as this brief's own final line, do not restate it here.
```
