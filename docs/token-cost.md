...
- **The semicolon and dash rules are warn-first, and the charset and duplicate-word rules gate, being clean tree-wide.** Compare its hits against the next batch of review findings before enforcing it, and do not claim the mechanical share until that comparison exists.
