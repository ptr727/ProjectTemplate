...
2. **Spelling**: All spelling must be clean via the CSpell VS Code integration; words must be correctly spelled in US or UK English. Project-specific terms go in the workspace CSpell config.
